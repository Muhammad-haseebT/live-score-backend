...
public class VolleyballScoringService implements ScoringServiceInterface {
    ...
    private VolleyballEvent handleSub(VolleyballScoreDTO req,
    ...
    private void undoEndSet(VolleyballMatchState state) {
        ...
        state.setTeam1Timeouts(0); state.setTeam2Timeouts(0);
        state.setStatus("LIVE");
    ...
    private VolleyballEvent build(Match match, Team team, Player player,
        ...
        ev.setEventType(type); ev.setSetNumber(state.getCurrentSet());
    ...
    private VolleyballMatchState createInitialState(Long matchId) {
        ...
        s.setTeam1Sets(0);   s.setTeam2Sets(0);
        s.setCurrentSet(1);  s.setStatus("LIVE");
        s.setTeam1Timeouts(0); s.setTeam2Timeouts(0);
    ...
    private VolleyballEventDTO toEventDTO(VolleyballEvent ev) {
        ...
        dto.setSetNumber(ev.getSetNumber()); dto.setEventTimeSeconds(ev.getEventTimeSeconds());
